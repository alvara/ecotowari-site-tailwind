    ...
    <div id="about">
      ...
      <div className="row">
          ...
          <div className="row row-cols-2 row-cols-sm-3 row-cols-lg-3 row-cols-xl-4  text-center">
            {tags.map((tag) => (
              <div key={tag._id}>
                ...
                <h3 className="icon-title mb-sm-5 mb-4">{tag.title}</h3>
              </div>
            ))}
          </div>
        </div>
        <div className="col-sm-12 col-md-12 col-lg-6">
          {/* Bio and History */}
          <p>
            I&apos;m a self-driven, team-oriented software engineer based in
            Tokyo.
          </p>
          <p>
            I am fascinated with web technology and on how it can be utilized to
            solve issues for businesses and create value.
          </p>
          <p>
            I am currently focused on building websites and web applications
            with a Jamstack architecture, utilizing NextJS, Netlify, and various
            headless CMS such as SanityIO and Supabase to power the backend.
          </p>
          <div className="row">
