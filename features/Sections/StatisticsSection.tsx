    ...
    <Section className="grid-cols-1 gap-8" backgroundColor="bg-slate-50">
      <div className="col-span-1 text-left md:col-span-1">
        ...
        <Typography variant="p" lineBreak>
          ...
          by {avgWastePerWeek} grams per week on average (tests done in the
          Tokyo region). It might not seem like much in itself but imagine the
          impact that all the ecotowari stickers together are having...
        </Typography>
